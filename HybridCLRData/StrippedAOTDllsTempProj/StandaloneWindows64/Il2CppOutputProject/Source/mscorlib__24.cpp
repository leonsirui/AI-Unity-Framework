...
{
	{
		...
		NullCheck(L_1);
		VirtualActionInvoker3< CharU5BU5D_t799905CF001DD5F13F7DBB310181FC4D8B7D0AAB*, int32_t, int32_t >::Invoke(15, __this, L_0, 0, ((int32_t)(((RuntimeArray*)L_1)->max_length)));
		return;
	}
}
...
IL_0004:
	...
	}
	{
		...
		VirtualActionInvoker1< CharU5BU5D_t799905CF001DD5F13F7DBB310181FC4D8B7D0AAB* >::Invoke(14, __this, L_4);
		return;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CStreamWriter_WriteLine_mA01BC2C9A80D4B4A660C3480FAF8B5F16D77B940 (CStreamWriter_t3311453DAB9CB3E60FD80FD196E9421A8EDF8239* __this, String_t* ___0_val, const RuntimeMethod* method) 
{
	{
		String_t* L_0 = ___0_val;
		VirtualActionInvoker1< String_t* >::Invoke(16, __this, L_0);
		String_t* L_1;
		L_1 = VirtualFuncInvoker0< String_t* >::Invoke(12, __this);
		VirtualActionInvoker1< String_t* >::Invoke(16, __this, L_1);
		return;
	}
}
#ifdef __clang__
