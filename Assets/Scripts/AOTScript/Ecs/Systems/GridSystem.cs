...
namespace GameFramework.ECS.Systems
{
    ...
    public class IslandData
    {
        ...
        public List<int2> BuildArea;
        public List<int2> AttachmentPoint;
    }
    ...
    public partial class GridSystem : SystemBase
    {
        ...
        public bool RegisterIsland(int3 anchorPos, IslandData data, int rotationIndex)
        {
            ...
            if (data.BuildArea != null)
            {
                ...
                {
                    int2 offset = RotateCoordinate(coord.x, coord.y, rotationIndex, data.Length, data.Width);
